    ...
    return (
        <div>
            ...
            <div
                ...
                className="   font-thin text-xl text-white  md:hover:text-2xl hover:brightness-100 md:ease-in duration-200 bg-cover bg-opacity-50 h-[20vh] shadow-xl m-5 rounded-xl flex justify-start p-2 items-end text-center"
                style={{
