    ...
    return (
        <div className=' h-[60%] flex flex-col justify-between items-center mb-20 '>
            ...
            <div className="group  ">
                ...
                <div className="    md:m-9 p-34 hover:hidden  text-cyan-300    hidden md:block group-hover:bg-black  group-hover:opacity-50 duration-[2s]   ease-out  opacity-0  md:-p-20 absolute  bottom-0 left-0 "> Hey there! Meet LinkeR, your new best friend for keeping tabs on YouTube videos. Just drop the URL and add a title, and boom! You’ve got a watchlist ready to go whenever you are. No more lost links or forgotten vids – LinkeR’s got your back.</div>
            </div>
